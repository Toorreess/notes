...
.include "configuration.inc" 
 	ldr  r0, =0x2020001C  	/*r0 contents the port address for ON */
	ldr  r2, =0x20200028  	/*r0 contents the port address for ON */
	ldr  r3, =0x20200034  	/*r0 contents the port address for ON */
	ldr  r1, =0x08420E00		
	str  r1,[r0]
loop:
	ldr  r8,[r3]
